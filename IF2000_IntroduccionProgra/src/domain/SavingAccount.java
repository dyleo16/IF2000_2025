...
public class SavingAccount extends Account {
    ...
    @Override
    public double interestCalculation() {   // corregido con 'c' minúscula
    ...
    public String toString() {   
        String result = "\nAccount Type: SAVING ACCOUNT"
                ...
                + "\n Gained Interest: " + ((this.getMonths() * super.getBalance() / 100) + this.getInterest())
                + "\n Balance after interest: " + (this.getBalance() + ((this.getMonths() * super.getBalance() / 100) + this.getInterest()));             
